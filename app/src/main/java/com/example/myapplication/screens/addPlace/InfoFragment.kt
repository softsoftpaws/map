...
class InfoFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        view.findViewById<AppCompatButton>(R.id.place_save).setOnClickListener {
            val name =
                view.findViewById<TextInputEditText>(R.id.place_name_edit).text.toString().trim()
            val type =
                view.findViewById<TextInputEditText>(R.id.place_type_edit).text.toString().trim()
            val days =
                view.findViewById<TextInputEditText>(R.id.place_opening_days_edit).text.toString()
                    .trim()
            val phone =
                view.findViewById<TextInputEditText>(R.id.place_phone_edit).text.toString().trim()
            val site =
